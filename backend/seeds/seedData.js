...
const items = [
  { name: 'Nike Air Zoom Pegasus 40', description: 'Comfortable running shoes for everyday training with responsive cushioning', price: 59.99, stockQuantity: 100, brand: 'Nike', size: 'M', color: 'Black', category: 'Shoes', material: 'Mesh', imageUrl: 'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/1abaae51-d7c4-4ca6-8e2b-8133b90d168b/AIR+ZOOM+PEGASUS+40.png' },
  { name: 'Adidas Ultraboost 22', description: 'High-performance running shoes with Boost cushioning for long runs', price: 179.99, stockQuantity: 150, brand: 'Adidas', size: 'M', color: 'Blue', category: 'Shoes', material: 'Primeknit', imageUrl: 'https://example.com/images/adidas-ultraboost-22.jpg' },
  { name: 'Nike Dri-FIT Miler T-shirt', description: 'Breathable running t-shirt for optimal comfort during long runs', price: 29.99, stockQuantity: 200, brand: 'Nike', size: 'L', color: 'White', category: 'Clothing', material: 'Polyester', imageUrl: 'https://example.com/images/nike-dri-fit-miler-tshirt.jpg' },
  { name: 'Puma Performance Cap', description: 'Protective cap with moisture-wicking properties for sun protection during runs', price: 14.99, stockQuantity: 80, brand: 'Puma', size: 'One Size', color: 'Gray', category: 'Accessories', material: 'Polyester', imageUrl: 'https://example.com/images/puma-performance-cap.jpg' },
